...
def test_classifier_init(classifier_instance):
    ...
    assert isinstance(classifier_instance, DimensionalityReduction)
...
def test_on_train_start(default_classifier_instance, has_P: bool):
    ...
    with (
        ...
        patch.object(
            DimensionalityReduction, "training_step", autospec=True
        ) as mocked_training_step,
        patch.object(DimensionalityReduction, "on_train_epoch_start"),
        patch.object(DimensionalityReduction, "on_train_epoch_end"),
    ):
...
def test_on_train_epoch_start(
    ...
    with (
        patch.object(DimensionalityReduction, "on_train_start"),
        patch.object(
            DimensionalityReduction, "training_step", autospec=True
        ) as mocked_training_step,
        patch.object(DimensionalityReduction, "on_train_epoch_end"),
...
def test_training_step(default_classifier_instance):
    ...
    with patch.object(DimensionalityReduction, "on_train_start"):
        trainer.fit(classifier_instance, test_data)
...
def test_on_validation_start(
    ...
    with (
        patch.object(ParametricTSNE, "_calculate_P") as mocked_calculate_P,
        patch.object(
            DimensionalityReduction, "validation_step", autospec=True
...
def test_validation_step(
    ...
    with patch.object(DimensionalityReduction, "on_validation_start"):
        trainer.fit(classifier_instance, test_data, test_val_data)
